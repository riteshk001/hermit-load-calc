...
#[allow(dead_code)]
pub static RUSTC: &str = "/home/karki/.rustup/toolchains/nightly-2026-04-01-x86_64-unknown-linux-gnu/bin/rustc";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/home/karki/.rustup/toolchains/nightly-2026-04-01-x86_64-unknown-linux-gnu/bin/rustdoc";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(dead_code)]
pub static FEATURES: [&str; 18] = ["acpi", "common-os", "dhcpv4", "dns", "fork", "fsgsbase", "kernel-stack", "net", "pci", "pci-ids", "semihosting", "smoltcp", "smp", "tcp", "udp", "virtio", "virtio-fs", "virtio-net"];
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The features as a comma-separated string."#]
#[allow(dead_code)]
pub static FEATURES_STR: &str = "acpi, common-os, dhcpv4, dns, fork, fsgsbase, kernel-stack, net, pci, pci-ids, semihosting, smoltcp, smp, tcp, udp, virtio, virtio-fs, virtio-net";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The features as above, as lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE: [&str; 18] = ["acpi", "common-os", "dhcpv4", "dns", "fork", "fsgsbase", "kernel-stack", "net", "pci", "pci-ids", "semihosting", "smoltcp", "smp", "tcp", "udp", "virtio", "virtio-fs", "virtio-net"];
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The feature-string as above, from lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE_STR: &str = "acpi, common-os, dhcpv4, dns, fork, fsgsbase, kernel-stack, net, pci, pci-ids, semihosting, smoltcp, smp, tcp, udp, virtio, virtio-fs, virtio-net";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/home/karki/.rustup/toolchains/nightly-2026-04-01-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.96.0-nightly (48cc71ee8 2026-03-31)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/home/karki/.rustup/toolchains/nightly-2026-04-01-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/karki/.rustup/toolchains/nightly-2026-04-01-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
...
#[allow(dead_code)]
pub static BUILT_TIME_UTC: &str = "Mon, 20 Jul 2026 21:23:15 +0000";
#[allow(clippy::needless_raw_string_hashes)]
